...
#include "MPRAT_WaitTargetDataUsingActor.generated.h"
 ...
 */
UCLASS()
class MAPLERISK_API UMPRAT_WaitTargetDataUsingActor : public UAbilityTask
{
	...
	*/
	...
	static UMPRAT_WaitTargetDataUsingActor* WaitTargetDataWithReusableActor(
