...
#include "MPRTargetTypes.generated.h"
...
class MAPLERISK_API UMPRTargetType : public UObject
{
	GENERATED_BODY()
...
class MAPLERISK_API UMPRTargetType_UseOwner : public UMPRTargetType
{
	GENERATED_BODY()

public:
	// Constructor and overrides
	UMPRTargetType_UseOwner() {}
...
UCLASS(NotBlueprintable)
class MAPLERISK_API UMPRTargetType_UseEventData : public UMPRTargetType
{
	GENERATED_BODY()

public:
	// Constructor and overrides
	UMPRTargetType_UseEventData() {}
