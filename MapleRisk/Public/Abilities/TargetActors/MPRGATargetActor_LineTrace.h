...
#include "MPRGATargetActor_LineTrace.generated.h"

/**
 * Reusable, configurable line trace TargetActor.
 * Meant to be used with WaitTargetDataUsingActor instead of the default WaitTargetData AbilityTask as the default
 * one will destroy the TargetActor.
 */
UCLASS()
class MAPLERISK_API AMPRGATargetActor_LineTrace : public AMPRGATargetActor_Trace
{
	GENERATED_BODY()
	
public:
	AMPRGATargetActor_LineTrace();
